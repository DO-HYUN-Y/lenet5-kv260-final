...
set out_dir [file join $root build maxpool_dpic]
file mkdir $out_dir
cd $out_dir

set rtl [file join $root rtl maxpool2x2_int8.sv]
set tb [file join $root tb tb_maxpool2x2_int8.sv]
...
exec xsc $golden
exec xelab tb_maxpool2x2_int8 -debug typical -sv_lib dpi \
    -cc_db $coverage_db
...
puts "MAXPOOL_DPIC_PASS seed=$seed random_count=$random_count"
