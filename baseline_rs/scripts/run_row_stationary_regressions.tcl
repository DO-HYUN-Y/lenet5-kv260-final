...
foreach name {sa graph control weight_dma_bridge gather} {lappend test_sources [file join $rs_root tb tb_alexnet_row_stationary_${name}.sv]}
...
foreach top {tb_alexnet_row_stationary_sa tb_alexnet_row_stationary_graph tb_alexnet_row_stationary_control tb_alexnet_row_stationary_weight_dma_bridge tb_alexnet_row_stationary_gather tb_alexnet_hybrid_schedule_trace} {
