...
module_path="${software_dir}/../../alexnet/software/driver/alexnet_board.ko"
bitstream_path="${firmware_dir}/alexnet_pure_rs_kv260.bit.bin"
overlay_path="${firmware_dir}/alexnet_pure_rs_kv260.dtbo"
...
load_fpga() {
    ...
    echo "ALEXNET_PURE_RS_KV260_FPGA_LOAD_PASS"
}
...
probe_driver() {
    ...
    echo "ALEXNET_PURE_RS_KV260_DRIVER_PROBE_PASS"
}
