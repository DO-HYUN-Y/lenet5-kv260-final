# Derived from the pinned shared builder; weight DRE enabled for RS N*K addresses.
...
if {$add_weight_dma} {
    # Weight row slices can be unaligned and uses a dedicated HP3 read path.
...
if {$use_four_hp} {
    puts $summary_file "ACCELERATOR_R=128_FILTER_ROWS"
} else {
