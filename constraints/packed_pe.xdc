## OOC synthesis/implementation constraints for packed_pe.sv
## Target: KV260 (xck26-sfvc784-2LV-c), 200 MHz PL clock (my_self.md)
create_clock -period 5.000 -name clk [get_ports clk]

## en/inputs are combinational into DSP AREG/DREG/BREG regs; give them a
## modest input delay budget so STA reports a meaningful setup slack instead
## of defaulting to 0 (typical for OOC block-level per-module timing checks).
