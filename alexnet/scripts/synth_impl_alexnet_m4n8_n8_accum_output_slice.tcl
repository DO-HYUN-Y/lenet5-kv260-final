...
set xdc_source [file join $alexnet_root constraints \
    alexnet_m4n8_n8_accum_output_slice.xdc]
set out_dir [file join $alexnet_root build m4n8_n8_accum_output_slice_ooc \
    200mhz]
set report_dir [file join $alexnet_root reports m4n8_n8_accum_output_slice \
    200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_m4n8_n8_accum_output_slice -part $part \
    -mode out_of_context
...
puts $metadata_file "design=alexnet_m4n8_n8_accum_output_slice"
puts $metadata_file "integration=scanner,partial_sum_bank,requant,router"
puts $metadata_file "logical_shape=m4xn8"
puts $metadata_file "partial_sum_depth_words=512"
puts $metadata_file "partial_sum_word_bits=256"
puts $metadata_file "metadata_policy=row_local_m_and_tile_tag_reconstruction"
...
close $metadata_file
puts "ALEXNET_M4N8_N8_ACCUM_OUTPUT_SLICE_OOC_DONE frequency_mhz=$frequency_mhz"
