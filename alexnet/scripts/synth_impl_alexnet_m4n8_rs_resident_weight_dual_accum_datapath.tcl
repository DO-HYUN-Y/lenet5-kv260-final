...
set xdc_source [file join $alexnet_root constraints \
    alexnet_m4n8_rs_resident_weight_dual_accum_datapath.xdc]
set out_dir [file join $alexnet_root build \
    m4n8_rs_resident_weight_dual_accum_datapath_ooc 200mhz]
set report_dir [file join $alexnet_root reports \
    m4n8_rs_resident_weight_dual_accum_datapath 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_m4n8_rs_resident_weight_dual_accum_datapath \
...
puts $metadata_file \
    "design=alexnet_m4n8_rs_resident_weight_dual_accum_datapath"
puts $metadata_file \
    "integration=rs_feeder,resident_weight_bank,issue_controller,sa,scanner,dual_partial_sum_bank,requant,router"
...
close $metadata_file
puts \
    "ALEXNET_M4N8_RS_RESIDENT_WEIGHT_DUAL_ACCUM_DATAPATH_OOC_DONE frequency_mhz=$frequency_mhz"
