...
set xdc_source \
    [file join $alexnet_root constraints alexnet_dma_chunk_scheduler.xdc]
set out_dir [file join $alexnet_root build dma_chunk_scheduler_ooc 200mhz]
set report_dir [file join $alexnet_root reports dma_chunk_scheduler 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_dma_chunk_scheduler -part $part \
    -mode out_of_context
...
puts $metadata_file "design=alexnet_dma_chunk_scheduler"
puts $metadata_file "command_slots=1"
puts $metadata_file "buffered_sequence=activation_dma,pre_weight_release,weight_dma,result_dma_if_final,chunk,post_weight_release,result_completion_if_final"
puts $metadata_file "streaming_sequence=pre_weight_release_if_needed,weight_dma,result_dma_if_final,chunk_with_direct_activation_stream,post_weight_release,result_completion_if_final"
puts $metadata_file "streaming_activation_dma_descriptor_skipped=true"
puts $metadata_file "final_chunk_waits_for_result_dma_active=true"
puts $metadata_file "accept_requires_quiescent_command_boundary=true"
puts $metadata_file "nonfinal_completion_allows_open_accum_transaction=true"
puts $metadata_file "final_completion_waits_for_pipeline_idle=true"
puts $metadata_file "downstream_fault_state_stable_until_clear=true"
puts $metadata_file "owned_transfers_drain_before_error_clear=true"
puts $metadata_file "pe_rtl_changed=false"
puts $metadata_file "sa_rtl_changed=false"
puts $metadata_file "datapath_rtl_changed=false"
...
close $metadata_file
puts "ALEXNET_DMA_CHUNK_SCHEDULER_OOC_DONE frequency_mhz=$frequency_mhz"
