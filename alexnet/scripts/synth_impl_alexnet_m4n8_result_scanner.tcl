...
set rtl_source [file join $alexnet_root rtl result alexnet_m4n8_result_scanner.sv]
set xdc_source [file join $alexnet_root constraints alexnet_m4n8_result_scanner.xdc]
set out_dir [file join $alexnet_root build m4n8_scanner_ooc 200mhz]
set report_dir [file join $alexnet_root reports m4n8_scanner 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_m4n8_result_scanner -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_m4n8_result_scanner"
...
close $metadata_file
puts "ALEXNET_M4N8_SCANNER_OOC_DONE frequency_mhz=$frequency_mhz"
