...
set rtl_source [file join $alexnet_root rtl result alexnet_n8_output_router.sv]
set xdc_source [file join $alexnet_root constraints alexnet_n8_output_router.xdc]
set out_dir [file join $alexnet_root build n8_router_ooc 200mhz]
set report_dir [file join $alexnet_root reports n8_router 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_output_router -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_output_router"
puts $metadata_file "fifo_depth=64"
puts $metadata_file "payload_bits=64"
puts $metadata_file "fifo_word_bits=85"
...
close $metadata_file
puts "ALEXNET_N8_ROUTER_OOC_DONE frequency_mhz=$frequency_mhz"
