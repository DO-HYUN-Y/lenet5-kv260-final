...
set rtl_source [file join $alexnet_root rtl pool alexnet_n8_maxpool3x3.sv]
set xdc_source [file join $alexnet_root constraints alexnet_n8_maxpool3x3.xdc]
set out_dir [file join $alexnet_root build n8_maxpool3x3_ooc 200mhz]
set report_dir [file join $alexnet_root reports n8_maxpool3x3 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_maxpool3x3 -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_maxpool3x3"
puts $metadata_file "lanes=8"
puts $metadata_file "kernel=3x3"
puts $metadata_file "stride=2x2"
puts $metadata_file "padding=0x0"
puts $metadata_file "max_input_width=55"
...
close $metadata_file
puts "ALEXNET_N8_MAXPOOL3X3_OOC_DONE frequency_mhz=$frequency_mhz"
