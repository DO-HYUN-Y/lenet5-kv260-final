...
set rtl_source [file join $alexnet_root rtl postprocess alexnet_n8_requant.sv]
set xdc_source [file join $alexnet_root constraints alexnet_n8_requant.xdc]
set out_dir [file join $alexnet_root build n8_requant_ooc 200mhz]
set report_dir [file join $alexnet_root reports n8_requant 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_requant -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_requant"
puts $metadata_file "lanes=8"
puts $metadata_file "pipeline_stages=5"
puts $metadata_file "arithmetic=signed27x18_half_away_int8"
...
close $metadata_file
puts "ALEXNET_N8_REQUANT_OOC_DONE frequency_mhz=$frequency_mhz"
