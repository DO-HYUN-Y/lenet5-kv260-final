...
set rtl_source [file join $alexnet_root rtl feeder alexnet_n8_rs_m4_feeder.sv]
set xdc_source [file join $alexnet_root constraints alexnet_n8_rs_m4_feeder.xdc]
set out_dir [file join $alexnet_root build n8_rs_m4_feeder_ooc 200mhz]
set report_dir [file join $alexnet_root reports n8_rs_m4_feeder 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_rs_m4_feeder -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_rs_m4_feeder"
puts $metadata_file "input_lanes=8"
puts $metadata_file "output_m=4"
puts $metadata_file "max_kernel=11"
puts $metadata_file "max_input_width=224"
puts $metadata_file "ring_rows=11"
puts $metadata_file "ring_width=228"
puts $metadata_file "ring_storage_words=2560"
...
close $metadata_file
puts "ALEXNET_N8_RS_M4_FEEDER_OOC_DONE frequency_mhz=$frequency_mhz"
