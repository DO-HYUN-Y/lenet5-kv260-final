...
set top_source [file join $alexnet_root rtl integration alexnet_m4n8_n8_output_slice.sv]
set xdc_source [file join $alexnet_root constraints alexnet_m4n8_n8_output_slice.xdc]
set out_dir [file join $alexnet_root build m4n8_n8_output_slice_ooc 200mhz]
set report_dir [file join $alexnet_root reports m4n8_n8_output_slice 200mhz]
file mkdir $out_dir
file mkdir $report_dir
cd $out_dir

read_verilog -sv [list $scanner_source $requant_source $router_source $top_source]
read_xdc $xdc_source
synth_design -top alexnet_m4n8_n8_output_slice -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_m4n8_n8_output_slice"
puts $metadata_file "slice_index=0"
puts $metadata_file "fifo_depth=64"
puts $metadata_file "integration=scanner_requant_router"
...
close $metadata_file
puts "ALEXNET_M4N8_N8_OUTPUT_SLICE_OOC_DONE frequency_mhz=$frequency_mhz"
