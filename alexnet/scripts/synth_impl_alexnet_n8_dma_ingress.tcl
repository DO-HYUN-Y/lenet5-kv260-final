...
set rtl_source [file join $alexnet_root rtl dma alexnet_n8_dma_ingress.sv]
set xdc_source [file join $alexnet_root constraints alexnet_n8_dma_ingress.xdc]
set out_dir [file join $alexnet_root build n8_dma_ingress_ooc 200mhz]
set report_dir [file join $alexnet_root reports n8_dma_ingress 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_dma_ingress -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_dma_ingress"
puts $metadata_file "axis_width_bits=128"
puts $metadata_file "internal_word_bits=64"
puts $metadata_file "destinations=activation_direct,activation_pooled,resident_weight"
puts $metadata_file "descriptor_buffer_depth=1"
puts $metadata_file "axis_buffer_depth_beats=1"
puts $metadata_file "activation_max_words=1024"
puts $metadata_file "weight_max_words=968"
puts $metadata_file "invalid_descriptor_consumes_owner=false"
...
close $metadata_file
puts "ALEXNET_N8_DMA_INGRESS_OOC_DONE frequency_mhz=$frequency_mhz"
