...
set rtl_sources [list \
    ...
    [file join $alexnet_root rtl integration \
        alexnet_m4n8_fc_activation_resident_weight_accum_datapath.sv]]
set xdc_source [file join $alexnet_root constraints \
    alexnet_m4n8_fc_activation_resident_weight_accum_datapath.xdc]
set out_dir [file join $alexnet_root build \
    m4n8_fc_activation_resident_weight_accum_datapath_ooc 200mhz]
set report_dir [file join $alexnet_root reports \
    m4n8_fc_activation_resident_weight_accum_datapath 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_m4n8_fc_activation_resident_weight_accum_datapath \
...
puts $metadata_file \
    "design=alexnet_m4n8_fc_activation_resident_weight_accum_datapath"
puts $metadata_file \
    "integration=activation_bank,fc_issuer,resident_weight_bank,sa,scanner,partial_sum_bank,requant,router"
...
close $metadata_file
puts \
    "ALEXNET_M4N8_FC_ACTIVATION_RESIDENT_WEIGHT_ACCUM_DATAPATH_OOC_DONE frequency_mhz=$frequency_mhz"
