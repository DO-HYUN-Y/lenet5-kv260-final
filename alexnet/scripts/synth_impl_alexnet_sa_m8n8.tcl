...
set out_dir [file join $alexnet_root build sa_m8n8_ooc 200mhz]
set report_dir [file join $alexnet_root reports sa_m8n8 200mhz]
file mkdir $out_dir
...
set tile_source [file join $alexnet_root rtl sa alexnet_sa_m8n8.sv]
set xdc_source [file join $alexnet_root constraints alexnet_sa_m4n8.xdc]
read_verilog -sv $pe_source $base_source $tile_source
read_xdc $xdc_source
synth_design -top alexnet_sa_m8n8 -part $part -mode out_of_context

set synth_dsp_count [llength [get_cells -hierarchical -filter {REF_NAME == DSP48E2}]]
if {$synth_dsp_count != 32} {
  error "M8xN8 SA expected 32 DSP48E2 after synthesis, got $synth_dsp_count"
}
...
if {$setup_wns < 0.0 || $hold_whs < 0.0} {
  error "M8xN8 SA failed 200 MHz timing: WNS=$setup_wns WHS=$hold_whs"
}
...
puts $metadata_file "design=alexnet_sa_m8n8"
puts $metadata_file "logical_shape=M8xN8"
puts $metadata_file "physical_shape=4x8"
...
puts "ALEXNET_SA_M8N8_OOC_PASS frequency_mhz=$frequency_mhz dsp=$synth_dsp_count WNS=$setup_wns WHS=$hold_whs"
