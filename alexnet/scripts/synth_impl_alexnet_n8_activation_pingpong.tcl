...
set xdc_source \
    [file join $alexnet_root constraints alexnet_n8_activation_pingpong.xdc]
set out_dir [file join $alexnet_root build n8_activation_pingpong_ooc 200mhz]
set report_dir [file join $alexnet_root reports n8_activation_pingpong 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_activation_pingpong -part $part \
    -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_activation_pingpong"
puts $metadata_file "lanes=8"
puts $metadata_file "bank_count=2"
puts $metadata_file "bank_depth_words=512"
puts $metadata_file "word_bits=64"
puts $metadata_file "ready_queue_depth=2"
puts $metadata_file "write_sources=direct,pooled"
puts $metadata_file "same_bank_read_write_overlap=false"
puts $metadata_file "cross_bank_read_write_overlap=true"
puts $metadata_file "single_bank_rtl_changed=false"
...
close $metadata_file
puts "ALEXNET_N8_ACTIVATION_PINGPONG_OOC_DONE frequency_mhz=$frequency_mhz"
