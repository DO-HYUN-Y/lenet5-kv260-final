...
set out_dir [file join $alexnet_root build \
    m4n8_rs_dma_io_activation_resident_weight_dual_accum_datapath_sim]
file mkdir $out_dir
...
exec xvlog -sv -d SIMULATION \
    ...
    [file join $alexnet_root tb \
        tb_alexnet_m4n8_rs_dma_io_activation_resident_weight_dual_accum_datapath.sv]
exec xelab \
    tb_alexnet_m4n8_rs_dma_io_activation_resident_weight_dual_accum_datapath \
    -debug typical
exec xsim \
    tb_alexnet_m4n8_rs_dma_io_activation_resident_weight_dual_accum_datapath \
    -runall
...
if {![string match \
  ...
  error "AlexNet full DMA-loop RS simulation failed; see $log_path"
}
puts \
    "ALEXNET_M4N8_RS_DMA_IO_ACTIVATION_RESIDENT_WEIGHT_DUAL_ACCUM_DATAPATH_SIM_PASS"
