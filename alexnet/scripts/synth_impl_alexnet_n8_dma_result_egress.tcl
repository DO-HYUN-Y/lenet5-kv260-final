...
set xdc_source \
    [file join $alexnet_root constraints alexnet_n8_dma_result_egress.xdc]
set out_dir [file join $alexnet_root build n8_dma_result_egress_ooc 200mhz]
set report_dir [file join $alexnet_root reports n8_dma_result_egress 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_dma_result_egress -part $part \
    -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_dma_result_egress"
puts $metadata_file "axis_width_bits=128"
puts $metadata_file "internal_packet_bits=64"
puts $metadata_file "maximum_words=1024"
puts $metadata_file "descriptor_buffer_depth=1"
puts $metadata_file "packing_buffer_words=2"
puts $metadata_file "packing_order=low_word_then_high_word"
puts $metadata_file "odd_tail_tkeep=00ff"
puts $metadata_file "metadata_error_drains_transfer=true"
puts $metadata_file "completion_preserves_first_and_last_tile_tag=true"
puts $metadata_file "pe_rtl_changed=false"
puts $metadata_file "sa_rtl_changed=false"
puts $metadata_file "router_rtl_changed=false"
...
close $metadata_file
puts "ALEXNET_N8_DMA_RESULT_EGRESS_OOC_DONE frequency_mhz=$frequency_mhz"
