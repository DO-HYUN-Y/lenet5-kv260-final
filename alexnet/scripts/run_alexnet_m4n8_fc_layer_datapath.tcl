...
set sim_top tb_alexnet_m4n8_fc_layer_datapath
set out_dir [file join $alexnet_root build m4n8_fc_layer_datapath_sim]
...
exec {*}$simulator_env xvlog -sv -d SIMULATION \
    ...
    [file join $alexnet_root tb tb_alexnet_m4n8_fc_layer_datapath.sv]
