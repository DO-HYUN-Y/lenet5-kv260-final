...
set rtl_source [file join $alexnet_root rtl memory alexnet_n8_weight_tile_bank.sv]
set xdc_source [file join $alexnet_root constraints alexnet_n8_weight_tile_bank.xdc]
set out_dir [file join $alexnet_root build n8_weight_tile_bank_ooc 200mhz]
set report_dir [file join $alexnet_root reports n8_weight_tile_bank 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_weight_tile_bank -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_weight_tile_bank"
puts $metadata_file "lanes=8"
puts $metadata_file "depth_k_words=968"
puts $metadata_file "word_bits=64"
puts $metadata_file "ownership=empty_writing_ready_replaying_ready_release"
puts $metadata_file "replay_context=k_count,n_lane_mask,context_tag"
puts $metadata_file "successful_replay_retains_tile=true"
...
close $metadata_file
puts "ALEXNET_N8_WEIGHT_TILE_BANK_OOC_DONE frequency_mhz=$frequency_mhz"
