...
set out_dir [file join $alexnet_root build n8_rs_m4_feeder_sim]
...
close $log_file
if {![string match "*ALEXNET_N8_RS_M4_FEEDER_TEST_PASSED*" $log_text] ||
    [string match "*Fatal:*" $log_text] ||
    [string match "*ERROR:*" $log_text]} {
  error "AlexNet N8 RS M4 feeder simulation failed; see $log_path"
}
puts "ALEXNET_N8_RS_M4_FEEDER_DPI_PASS"
