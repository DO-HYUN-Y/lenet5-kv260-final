...
set xdc_source [file join $alexnet_root constraints \
    alexnet_m4n8_rs_dma_activation_resident_weight_dual_accum_datapath.xdc]
set out_dir [file join $alexnet_root build \
    m4n8_rs_dma_activation_resident_weight_dual_accum_datapath_ooc 200mhz]
set report_dir [file join $alexnet_root reports \
    m4n8_rs_dma_activation_resident_weight_dual_accum_datapath 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design \
    -top alexnet_m4n8_rs_dma_activation_resident_weight_dual_accum_datapath \
...
puts $metadata_file \
    "design=alexnet_m4n8_rs_dma_activation_resident_weight_dual_accum_datapath"
puts $metadata_file \
    "integration=axis128_dma_ingress,dual_segment_activation,rs_feeder,resident_weight_bank,issue_controller,sa,scanner,dual_partial_sum_bank,requant,router"
puts $metadata_file "logical_shape=m4xn8"
puts $metadata_file "physical_shape=2x8_packed_pe"
puts $metadata_file "axis_width_bits=128"
...
puts $metadata_file "dma_error_interlocks_chunk_launch=true"
...
puts $metadata_file "dma_child_rtl_changed=false"
...
close $metadata_file
puts \
    "ALEXNET_M4N8_RS_DMA_ACTIVATION_RESIDENT_WEIGHT_DUAL_ACCUM_DATAPATH_OOC_DONE frequency_mhz=$frequency_mhz"
