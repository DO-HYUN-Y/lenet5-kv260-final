...
set rtl_sources [list \
    ...
    [file join $alexnet_root rtl integration alexnet_m4n8_n8_output_slice.sv] \
    [file join $alexnet_root rtl integration alexnet_m4n8_base_datapath.sv] \
    [file join $alexnet_root rtl feeder alexnet_n8_rs_m4_feeder.sv] \
    [file join $alexnet_root rtl control alexnet_m4n8_rs_issue_controller.sv] \
    [file join $alexnet_root rtl integration alexnet_m4n8_rs_datapath.sv] \
    [file join $alexnet_root rtl memory alexnet_n8_weight_tile_bank.sv] \
    [file join $alexnet_root rtl integration \
        alexnet_m4n8_rs_resident_weight_datapath.sv]]
set xdc_source [file join $alexnet_root constraints \
    alexnet_m4n8_rs_resident_weight_datapath.xdc]
set out_dir [file join $alexnet_root build \
    m4n8_rs_resident_weight_datapath_ooc 200mhz]
set report_dir [file join $alexnet_root reports \
    m4n8_rs_resident_weight_datapath 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_m4n8_rs_resident_weight_datapath \
...
puts $metadata_file "design=alexnet_m4n8_rs_resident_weight_datapath"
puts $metadata_file "integration=weight_tile_bank,m4n8_rs_datapath"
puts $metadata_file "logical_shape=m4xn8"
puts $metadata_file "physical_packed_pe_grid=2x8"
puts $metadata_file "weight_policy=fill_once_replay_each_spatial_m_group"
puts $metadata_file "resident_scope=one_n8_output_tile_by_one_input_channel_chunk"
puts $metadata_file "cross_chunk_accumulation=false"
puts $metadata_file "frame_policy=weight_context_match_then_one_frame_until_drain"
...
foreach rtl_source $rtl_sources {
  puts $metadata_file "rtl_sha256.[file tail $rtl_source]=[lindex [exec sha256sum $rtl_source] 0]"
}
puts $metadata_file "xdc_sha256=[lindex [exec sha256sum $xdc_source] 0]"
close $metadata_file
puts "ALEXNET_M4N8_RS_RESIDENT_WEIGHT_DATAPATH_OOC_DONE frequency_mhz=$frequency_mhz"
