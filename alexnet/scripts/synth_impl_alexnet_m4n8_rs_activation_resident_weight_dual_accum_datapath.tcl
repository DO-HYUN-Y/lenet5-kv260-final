...
set xdc_source [file join $alexnet_root constraints \
    alexnet_m4n8_rs_activation_resident_weight_dual_accum_datapath.xdc]
set out_dir [file join $alexnet_root build \
    m4n8_rs_activation_resident_weight_dual_accum_datapath_ooc 200mhz]
set report_dir [file join $alexnet_root reports \
    m4n8_rs_activation_resident_weight_dual_accum_datapath 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design \
    -top alexnet_m4n8_rs_activation_resident_weight_dual_accum_datapath \
...
puts $metadata_file \
    "design=alexnet_m4n8_rs_activation_resident_weight_dual_accum_datapath"
puts $metadata_file \
    "integration=dual_segment_activation,rs_feeder,resident_weight_bank,issue_controller,sa,scanner,dual_partial_sum_bank,requant,router"
puts $metadata_file "logical_shape=m4xn8"
puts $metadata_file "physical_shape=2x8_packed_pe"
puts $metadata_file "activation_set_count=2"
puts $metadata_file "activation_segment_count_per_set=2"
puts $metadata_file "activation_segment_depth_words=512"
puts $metadata_file "activation_total_capacity_words_per_set=1024"
puts $metadata_file "weight_depth_words=968"
puts $metadata_file "partial_sum_segment_count=2"
puts $metadata_file "partial_sum_segment_depth_words=512"
puts $metadata_file "partial_sum_total_capacity_words=1024"
...
puts $metadata_file "activation_child_rtl_changed=false"
puts $metadata_file "compute_child_rtl_changed=false"
...
close $metadata_file
puts \
    "ALEXNET_M4N8_RS_ACTIVATION_RESIDENT_WEIGHT_DUAL_ACCUM_DATAPATH_OOC_DONE frequency_mhz=$frequency_mhz"
