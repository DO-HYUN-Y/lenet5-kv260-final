...
set xdc_source [file join $alexnet_root constraints \
    alexnet_m4n8_accum_base_datapath.xdc]
set out_dir [file join $alexnet_root build m4n8_accum_base_datapath_ooc \
    200mhz]
set report_dir [file join $alexnet_root reports m4n8_accum_base_datapath \
    200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_m4n8_accum_base_datapath -part $part \
    -mode out_of_context
...
puts $metadata_file "design=alexnet_m4n8_accum_base_datapath"
puts $metadata_file "integration=sa,scanner,partial_sum_bank,requant,router"
...
close $metadata_file
puts "ALEXNET_M4N8_ACCUM_BASE_DATAPATH_OOC_DONE frequency_mhz=$frequency_mhz"
