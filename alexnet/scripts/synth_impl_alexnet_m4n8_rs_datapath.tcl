...
set xdc_source [file join $alexnet_root constraints alexnet_m4n8_rs_datapath.xdc]
set out_dir [file join $alexnet_root build m4n8_rs_datapath_ooc 200mhz]
set report_dir [file join $alexnet_root reports m4n8_rs_datapath 200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_m4n8_rs_datapath -part $part -mode out_of_context
...
puts $metadata_file "design=alexnet_m4n8_rs_datapath"
puts $metadata_file "integration=rs_feeder,issue_controller,m4n8_base_datapath"
puts $metadata_file "logical_shape=m4xn8"
puts $metadata_file "physical_packed_pe_grid=2x8"
puts $metadata_file "weight_boundary=n8_lockstep_k_stream"
puts $metadata_file "frame_policy=one_descriptor_until_full_pipeline_drain"
...
close $metadata_file
puts "ALEXNET_M4N8_RS_DATAPATH_OOC_DONE frequency_mhz=$frequency_mhz"
