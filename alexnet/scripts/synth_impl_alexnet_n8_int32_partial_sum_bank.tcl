...
set rtl_source [file join $alexnet_root rtl memory \
    alexnet_n8_int32_partial_sum_bank.sv]
set xdc_source [file join $alexnet_root constraints \
    alexnet_n8_int32_partial_sum_bank.xdc]
set out_dir [file join $alexnet_root build n8_int32_partial_sum_bank_ooc \
    200mhz]
set report_dir [file join $alexnet_root reports n8_int32_partial_sum_bank \
    200mhz]
file mkdir $out_dir
...
read_xdc $xdc_source
synth_design -top alexnet_n8_int32_partial_sum_bank -part $part \
    -mode out_of_context
...
puts $metadata_file "design=alexnet_n8_int32_partial_sum_bank"
puts $metadata_file "lanes=8"
puts $metadata_file "depth_words=512"
puts $metadata_file "word_bits=256"
puts $metadata_file "accumulator_bits=32"
puts $metadata_file "chunk_policy=first_replace_middle_accumulate_final_emit"
...
close $metadata_file
puts "ALEXNET_N8_INT32_PARTIAL_SUM_BANK_OOC_DONE frequency_mhz=$frequency_mhz"
