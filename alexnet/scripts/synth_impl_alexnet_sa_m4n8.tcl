...
set out_dir [file join $alexnet_root build sa_m4n8_ooc 200mhz]
set report_dir [file join $alexnet_root reports sa_m4n8 200mhz]
file mkdir $out_dir
file mkdir $report_dir
cd $out_dir

set pe_source [file join $alexnet_root rtl packed_mac alexnet_packed_pe.sv]
set tile_source [file join $alexnet_root rtl sa alexnet_sa_m4n8.sv]
set xdc_source [file join $alexnet_root constraints alexnet_sa_m4n8.xdc]
read_verilog -sv $pe_source $tile_source
read_xdc $xdc_source
...
puts $metadata_file "design=alexnet_sa_m4n8"
puts $metadata_file "logical_shape=M4xN8"
puts $metadata_file "physical_shape=2x8"
...
puts "ALEXNET_SA_M4N8_OOC_DONE frequency_mhz=$frequency_mhz"
