...
// M8 wrapper for the N8 row-stationary feeder. Eight replicated ring-buffer
// read copies fetch all spatial lanes in parallel while writes are broadcast.
module alexnet_n8_rs_m8_feeder #(
    ...
    input logic m_ready,
    output logic signed [7:0] m_act_lo [0:3],
    output logic signed [7:0] m_act_hi [0:3],
    output logic [1:0] m_lane_mask [0:3],
