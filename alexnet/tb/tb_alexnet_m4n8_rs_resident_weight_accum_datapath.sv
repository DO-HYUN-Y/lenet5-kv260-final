...
module tb_alexnet_m4n8_rs_resident_weight_accum_datapath;
  ...
  alexnet_m4n8_rs_resident_weight_accum_datapath #(
  ...
  task automatic run_chunk(input int chunk_number);
    ...
    begin
      ...
      $display(
          "ALEXNET_M4N8_RS_RESIDENT_WEIGHT_ACCUM_PROGRESS chunk=%0d/%0d tiles=%0d replays=%0d source_words=%0d time=%0t",
  ...
  initial begin
    ...
    $display(
        "ALEXNET_M4N8_RS_RESIDENT_WEIGHT_ACCUM_DATAPATH_TEST_PASSED chunks=%0d tiles=%0d replays=%0d replay_words=%0d fill_words=%0d source_words=%0d packets=%0d rejects=%0d configs=%0d maxq=%0d pending_chunks=%0d seed=%0d",
