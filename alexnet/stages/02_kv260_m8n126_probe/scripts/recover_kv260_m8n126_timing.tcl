...
puts "M8N126 timing recovery starts at WNS=$initial_wns ns"
...
write_checkpoint -force [file join $project_dir \
    alexnet_m8n126_kv260_timing_clean.dcp]
write_bitstream -force [file join $output_dir alexnet_m8n126_kv260.bit]
write_hw_platform -fixed -include_bit -force \
    [file join $output_dir alexnet_m8n126_kv260.xsa]

puts "ALEXNET_M8N126_KV260_TIMING_RECOVERY_DONE WNS=$setup_slack WHS=$hold_slack"
close_project
exit
