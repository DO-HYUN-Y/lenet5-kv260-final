...
set ::alexnet_accelerator_top_override \
    alexnet_m8n126_resource_probe_top
set ::alexnet_accelerator_display_name_override \
    {AlexNet logical M8xN126 resource probe}
set ::alexnet_accelerator_description_override \
    {KV260 M8xN126 probe with a physical M8xN128 512-DSP systolic array}
...
puts $summary_file "HP3_RESERVED_FOR_WEIGHT_MM2S=1"
puts $summary_file \
    "BITSTREAM=[file join $output_dir alexnet_m8n126_kv260.bit]"
puts $summary_file \
    "XSA=[file join $output_dir alexnet_m8n126_kv260.xsa]"
close $summary_file
...
if {[llength $sa_dsp_cells] != 512 || [llength $dsp_cells] != 576 ||
    [llength $uram_cells] != 32 || [llength $bram_cells] < 80} {
...
# Publish only a fully routed, timing-clean image.
...
file copy -force $bit_source \
    [file join $output_dir alexnet_m8n126_kv260.bit]
write_hw_platform -fixed -include_bit -force \
    [file join $output_dir alexnet_m8n126_kv260.xsa]

puts "ALEXNET_M8N126_KV260_BITSTREAM_DONE frequency_mhz=200"
close_project
exit
