...
source [file join $stage_dir scripts package_alexnet_m4n8_ip.tcl]
source [file join $stage_dir scripts package_camera_adapter_ip.tcl]
source [file join $stage_dir scripts create_kv260_system.tcl]
...
puts $summary_file \
    "BITSTREAM=[file join $output_dir alexnet_m4n8_kv260.bit]"
puts $summary_file \
    "XSA=[file join $output_dir alexnet_m4n8_kv260.xsa]"
close $summary_file
...
# Publish board artifacts only after every sign-off gate passes.  Vivado can
# generate a .bit even when timing fails, so copying it earlier risks deploying
# a non-sign-off image.
...
file copy -force $bit_source \
    [file join $output_dir alexnet_m4n8_kv260.bit]
write_hw_platform -fixed -include_bit -force \
    [file join $output_dir alexnet_m4n8_kv260.xsa]

puts "ALEXNET_M4N8_KV260_BITSTREAM_DONE frequency_mhz=200"
close_project
exit
